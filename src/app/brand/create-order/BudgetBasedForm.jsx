...
const grades = [
  { id: 1, name: "Icon", followers: "1M+", engagement: "5%+", pricePerReel: 1000 },
  { id: 2, name: "Superstar", followers: "500K-1M", engagement: "4-5%", pricePerReel: 800 },
  { id: 3, name: "Celebrity", followers: "250K-500K", engagement: "3-4%", pricePerReel: 600 },
  { id: 4, name: "Celebrity Lite", followers: "100K-250K", engagement: "2-3%", pricePerReel: 400 },
  { id: 5, name: "Mega", followers: "50K-100K", engagement: "1.5-2%", pricePerReel: 300 },
  { id: 6, name: "Macro", followers: "25K-50K", engagement: "1-1.5%", pricePerReel: 200 },
  { id: 7, name: "Mid-Tier", followers: "10K-25K", engagement: "0.8-1%", pricePerReel: 150 },
  { id: 8, name: "Rising Star", followers: "5K-10K", engagement: "0.6-0.8%", pricePerReel: 100 },
  { id: 9, name: "Micro", followers: "2K-5K", engagement: "0.4-0.6%", pricePerReel: 75 },
  { id: 10, name: "Nano", followers: "1K-2K", engagement: "0.2-0.4%", pricePerReel: 50 }
];
      ...
      <Card>
        <form onSubmit={handleSubmit}>
          ...
          <CardContent className="space-y-6">
            ...
            <div>
              <Label className="mb-4 block">Select Influencer Grades</Label>
                      ...
                      return (
                        <div key={item.gradeId} className="flex items-center justify-between">
                          <div className="flex items-center gap-3">
                            <Avatar className="h-8 w-8 bg-red-500 flex justify-center items-center text-primary font-medium">
                              <span>{grade.id}</span>
                            </Avatar>
                            <div>
